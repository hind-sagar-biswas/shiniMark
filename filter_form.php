<div class="container shadow d-flex justify-content-center p-1 border col-sm ">
      ...
      <div class="btn-group">
        <select type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" name="category">
          <div class="dropdown-menu">
            <option selected disabled class="dropdown-item" value="null" hidden>CATEGORY</option>
            ...
            <option style="background-color:white;" value="Pornhwa" class="dropdown-item">Pornhwa</option>
          </div>
        </select>
      </div>
      ...
      <div class="btn-group">
        <select type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" name="status">
          <div class="dropdown-menu">
            ...
            <option selected disabled class="dropdown-item" value="null" hidden>STATUS</option>
    ...
    <div class="btn-group">
      ...
      <div class="btn-group">
        <select type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" name="sort">
          <div class="dropdown-menu">
            <option selected disabled class="dropdown-item" value="id" hidden>SORT BY</option>
      ...
      <div class="btn-group">
        <select type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" name="order">
          <div class="dropdown-menu">
            <option selected disabled class="dropdown-item" value="DESC" hidden>ORDER BY</option>
